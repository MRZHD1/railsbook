...
friendship = Friendship.create(user_id: user.id, friend_id: user5.id)
post = Post.create(author_id: user5.id, title: "Second post of the day 😀", body: "Here is a better post, the one before was mediocre in comparison. I am the post boom.")